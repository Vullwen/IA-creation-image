...
discriminateur.name="Discriminateur"

discriminateur.add(Conv2D(16, kernel_size=(3, 3), activation='relu', input_shape=(128,128,3)))
discriminateur.add(MaxPooling2D(pool_size=(2, 2)))
discriminateur.add(SpatialDropout2D(0.15))

discriminateur.add(Conv2D(16, kernel_size=(3, 3), activation='relu' ))
discriminateur.add(MaxPooling2D(pool_size=(2, 2)))
discriminateur.add(SpatialDropout2D(0.15))
...
discriminateur.add(MaxPooling2D(pool_size=(2, 2)))
discriminateur.add(SpatialDropout2D(0.4))
...
for iteration in range(iterations):
	...
	print()
	discriminateur.trainable = False
	combo.fit(bruit,labels_combo, epochs=1, batch_size=16)
